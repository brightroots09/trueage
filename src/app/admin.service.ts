...
export class AdminService {
  ...
  private _reportedImageUrl = "/admin/reports";
  private _deleteReportedImageUrl = "/admin/delete_reported_image";
  private _addToVotingListUrl = "/admin/add_to_voting_list";
